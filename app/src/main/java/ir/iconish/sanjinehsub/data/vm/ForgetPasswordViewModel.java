...
import ir.iconish.sanjinehsub.data.repository.ForgetPasswordRepository;
...
public class ForgetPasswordViewModel extends ViewModel {
    ...
    public void callForgetPasswordViewModel(String mobileNumber) {


      forgetPasswordRepository.callForgetPasswordRepository(mobileNumber,new VolleyCallback() {
          @Override
    ...
    public String getMobileNumber(){
        return forgetPasswordRepository.getMobileNumber();
    }
}
